...
<body>
	<head>
		...
		<link rel="icon" href="http://localhost/base/assets/img/favicon.png" type="image/png" />
		<title>User Aggrement | LinkedIn</title>
		<?php echo link_css('user_agreement'); ?>
	</head>
	<header id="TheHeader">
	...
	<div  id="maindiv">
      ...
      <div id="introdiv">
        ...
        <div id="missiondiv">
        <p id="ourdiv">Our User Agreement has been updated; <a href="<?php echo site_url('site/user_agreement') ?>">click here for a summary of the changes</a>.</p>
	        <h4>1.1. Purpose</h4>
        ...
        <div id="mustdiv">
	        ...
	        <p>You must comply with all applicable laws and this Agreement, as may be amended from time to time with or without advance notice, and the policies and processes explained in the following sections:
				...
				<ul>
					<li><a href="<?php echo site_url('site/user_agreement') ?>">DOs and DON’Ts</a>;</li>
					<li><p><a href="<?php echo site_url('site/user_agreement') ?>">Complaints Regarding Content Posted on the LinkedIn Website</a>; and</p></li>
					<li><a href="<?php echo site_url('site/user_agreement') ?>">LinkedIn’s Privacy Policy</a>.</li>
				</ul>
			</div>
            </div>
        ...
        <div id="serdiv">
            ...
            <p>In addition to Section 2.h. (“Notices and Service Messages”), we may notify you via postings on <a href="<?php echo site_url('site/user_agreement') ?>">www.linkedin.com</a>. You may contact us <a href="<?php echo site_url('site/user_agreement') ?>">here</a>. Or via mail or courier at: LinkedIn Corporation ATTN: Legal Department 2029 Stierlin Court Mountain View, CA 94043 USA Additionally, LinkedIn accepts service of process at this address. Any notices that you provide without compliance with this section shall have no legal effect.</p>
            </div>
            </div>
        ...
        <div id="usdiv">
           ...
           <div id="intro3div">
      	  <div id="listdiv">
	        <p>Here’s a list of some of the specific things we ask you to do and not do on LinkedIn. If you want a high-level summary of these, please check out our <a href="<?php echo site_url('site/user_agreement') ?>">Professional Community Guidelines</a>.</p>
	      </div>
        <div id="binddiv">
	        <h4>10.1. Do undertake the following:</h4><br/>
				<ol>
					...
					<li>Review and comply with our <a href="<?php echo site_url('site/user_agreement') ?>">Privacy Policy</a>;</li>
        ...
        <div id="binddiv">
	        <h4>10.2. Don’t undertake the following:</h4><br/>
				<ol>
					...
					<li>Duplicate, license, sublicense, publish, broadcast, transmit, distribute, perform, display, sell, rebrand, or otherwise transfer information found on LinkedIn (excluding content posted by you) except as permitted in this Agreement, <a href="<?php echo site_url('site/user_agreement') ?>">LinkedIn’s developer terms and policies</a>, or as expressly authorized by LinkedIn;</li>
        ...
        <div id="builtdiv">     
            ...
            <div id="lastdiv">
            	<div class="onediv">
					...
					<p>If you have questions or comments about this User Agreement, please contact us <a href="<?php echo site_url('site/user_agreement') ?>">online</a> or by physical mail at:</p>
            	</div>
            	<div class="onediv">
...
<footer id="footer">
		<div id="footer_wrapper">
			<ul>
				<li><strong><a id="help_center" href="<?php echo site_url('site/user_agreement') ?>">Help Center</a></strong></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">About</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Press</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Blog</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Careers</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Advertising</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Talent Solotions</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Tools</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Mobile</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Developers</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Publishers</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Language</a></li>
				<li id="last"><a href="<?php echo site_url('site/user_agreement') ?>">SlideShare</a></li>
			</ul>
			<ul>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">LinkedIn Updates</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">LinkedIn Influencers</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">LinkedIn Jobs</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Jobs Directory</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Company Directory</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Groups Directory</a></li>
				<li id="last"><a href="<?php echo site_url('site/user_agreement') ?>">Title Directory</a></li>
			<div id="copyright">
				<div id="copy_text">&copy; 2013</div>
			</div>
			<ul id="conditions">
				<li><a href="<?php echo site_url('site/user_agreement') ?>">User Agreement</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Privacy Policy</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Community Guidelines</a></li>
				<li><a href="<?php echo site_url('site/user_agreement') ?>">Cookie Policy</a></li>
				<li id="last" class="bottom"><a href="<?php echo site_url('site/user_agreement') ?>">Copyright Policy</a></li>
			</ul>
		</div>
		</div>
	</footer>
